...
INSTANCE_NAME = os.getenv("INSTANCE_NAME", "reviews-service")

app = FastAPI(
    title="Reviews Service",
    description="Movie reviews microservice with PostgreSQL and outbox-backed Kafka producer",
    version="1.0.0",
)
...
def startup():
    ...
    start_registration_heartbeat(
        ...
        instance_url=os.getenv("PUBLIC_URL", "http://reviews-service:8000"),
    )
